...
const Cart = () => {
    ...
    // Nuevo estado para los datos del comprador
    ...
    const handleConfirmPurchase = async () => {
        ...
        try {
            ...
            // Actualiza la estructura de la orden para incluir los datos del comprador
            const orderData = {
                ...
                <>
                    ...
                    <div className="cart-summary">
                        ...
                        <div className="buyer-form-container mt-6">
                            <h3 className="text-lg font-semibold mb-2">Completa tus Datos</h3>
                            <form>
                                <div className="mb-4">
