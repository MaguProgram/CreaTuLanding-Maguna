...
//                 text: 'Por favor, completa todos los campos de tus datos de contacto.',
//             });
//             setIsLoading(false);
//             return;
//         }
...
//                     icon: 'error',
//                     title: '¡Error!',
//                     text: `El producto "${productWithoutStock.Nombre}" no tiene stock suficiente.`,
//                 });
//                 return;
//             }
...
//                     text: 'Ocurrió un error al guardar la orden. Por favor, intente de nuevo.',
//                 });
//             }
//         } catch (err) {
//             console.error("Error al confirmar la compra:", err);
...
//                 text: 'Ocurrió un error inesperado. Por favor, revise su conexión.',
//             });
//         } finally {
//             setIsLoading(false);
//         }
